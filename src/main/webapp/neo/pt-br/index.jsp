...
<title>Análise de Distúrbios Geomagnéticos</title>
  ...
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#home"><i class="fa fa-bar-chart"></i>&nbsp;Análise de Distúrbios Geomagnéticos</a>
      </div>

      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#home" id="scrollToTop">Home</a></li>
          <li><a href="#geo-index" class="smoothScroll">Índice Geomagnético</a></li>
          <li><a href="#observatories" class="smoothScroll">Observatórios</a></li>
          <li><a href="#pt-br"><img src="../assets/img/br.png" width="20"></a></li>
          <li style="margin-left:-20px;"><a href="../index.jsp"><img src="../assets/img/us.png" width="20"></a></li>
        </ul>
      </div>
      <!--/.nav-collapse --> 
    </div>
...
<div id="geo-index" name="geo-index">
  <div class="container">
    <div class="row white">
      <div class="col-md-6">
        <h3 class="title-geo">O que é Índice Gemagnético?</h3>
...
<div id="observatories" name="observatories">
  <div class="container">
    <div class="row">
      <h2 class="centered">Observatórios</h2>
