...
@Embeddable
public class DataMinPk implements Serializable{
	private static final long serialVersionUID = 1L;
	
	@JoinColumn(name = "DMIN_IAGA", insertable = false, updatable = false)
	@ManyToOne(cascade=CascadeType.ALL)
	private Observatory observatory; //IAGA CODE (Observatory)
	@Column(name = "DMIN_DATE")
	private Date date; //Data date
	@Column(name = "DMIN_Hour")
	...
	public String toString() {
		return "DataMinPk [observatory=" + observatory + ", date=" + date + ", hour=" + hour + "]";
	}
